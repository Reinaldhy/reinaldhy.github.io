        ...
        <div class="container">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <br>
                        <a class="btn btn-outline-dark" href="tugas1.php" role="button">Tugas 1</a><br><br>
                        <a class="btn btn-outline-dark" href="tugas2.php" role="button">Tugas 2</a><br><br>
                        <a class="btn btn-outline-dark" href="tugas3.php" role="button">Tugas 3</a><br><br>
                        <a class="btn btn-outline-dark" href="tugas4.php" role="button">Tugas 4</a>
                    </div>
                </div>
            </div>
        </div>
